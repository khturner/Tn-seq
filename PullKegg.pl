...
sub usage() {
print<<EOF;
PullKegg, by Keith H. Turner (khturner@utexas.edu)

This program takes a GFF file on STDIN, searches http://www.kegg.jp for the locus_tag and returns a new GFF file with Kegg orthology and Kegg pathway information on STDOUT.
