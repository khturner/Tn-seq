...
parser.add_argument('-1', '--read1', help = 'Read 1 file (FASTQ)', required = True)
parser.add_argument('-2', '--read2', help = 'Read 2 file (FASTQ) if paired end sequencing performed and Tn end could be on either read')
